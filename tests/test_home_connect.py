...
class TestSequenceFunctions(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.tst.debug_input_value[self.tst.PIN_I_CLIENT_ID] = self.cred["CLIENT_ID"]
        ...
        # simulator
        # self.tst.auth_data.access_token = "eyJ4LWVudiI6IlBSRCIsImFsZyI6IlJTMjU2IiwieC1yZWciOiJFVSIsImtpZCI6InJldS1wc"\
        #                                   "m9kdWN0aW9uIn0.eyJmZ3JwIjpbXSwiY2x0eSI6InByaXZhdGUiLCJzdWIiOiJkZTc2YTNjMi"\
        #                                   "0yY2IzLTQ3MTAtODU0ZC04MmNkNjMwNzM5MTYiLCJhdWQiOiIwNjJEMzQ1NEFBRTM2RUZBMjU"\
        #                                   "yMDYxMkQxMDc0NTNBNkFFNEQyNjgyNTY3MzlERkFCOTQ5MTcyMjRBQzZFNzg0IiwiYXpwIjoi"\
        #                                   "MDYyRDM0NTRBQUUzNkVGQTI1MjA2MTJEMTA3NDUzQTZBRTREMjY4MjU2NzM5REZBQjk0OTE3Mj"\
        #                                   "I0QUM2RTc4NCIsInNjb3BlIjpbIklkZW50aWZ5QXBwbGlhbmNlIiwiTW9uaXRvciJdLCJpc3Mi"\
        #                                   "OiJFVTpQUkQ6MCIsImV4cCI6MTcwMTAwMTI4NiwiaWF0IjoxNzAwOTE0ODg2LCJqdGkiOiI2NT"\
        #                                   "kxNzRjNy04NGVmLTRmZmMtODhlNy05MmQ5NjgyMzIzMTUifQ.V3nBFAWjhVEY09GuqxuBdD5C"\
        #                                   "MHDFDvm0R08c_svqwSNxDrHki4GlerzMDTkJTxw751PjODaDblGR265PepOGaBJlTmontdgRi"\
        #                                   "vsKRTV6JHO22yJ7tJqmvFxghz5DJws6hT9LHI2xkB44TFjKs0wjBnBgoRaH-A4fwk03Yxaqre"\
        #                                   "CySkdg718nEIN6ti37odkaMOT-mxKoJFg9eIBDT69CISizSE5vqqYaXNwasAwqsPE2gQo1e3p"\
        #                                   "PYG32CAvxXdxV7ihP8UnonMIABcjbEscMqwOviAeatwbtuQaExqdFvVAks2VZylczSLiMiyUX"\
        #                                   "2JnlCUBU8JILYCozioKqn_XlYg"
    ...
    def test_get_auth_data(self):
        ...
        self.tst.auth_data = self.tst.AuthData()
    ...
    def test_outdated_access_token(self):
        ...
        self.tst.auth_data.access_token = "x"
